...
import jcolonia.daw2022.luis.g.contreras.VistaControl.VistaAltas;
...
public class ControlSumatorio {
	...
	private void cargarSumando() {
			//listaN=new ListaNúmeros();
			
			VistaAgregacion agreg = new VistaAgregacion(sc);
			ArrayList<Double> listaVacia = new ArrayList<Double>();
			conjunto = agreg.agregarValores(listaVacia);
